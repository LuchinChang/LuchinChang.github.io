...
{% include figure.liquid path="assets/img/ReLyMe/case.jpg" title="case" class="img-fluid rounded z-depth-1" caption="Figure 1: This is the music sheet of a Mandarin song “Rainbow” by Jay Chou. The colorful boxes illustrate the lyric-melody relationships we formulate." %}
...
{% include figure.liquid path="assets/img/ReLyMe/pitch_shape.jpg" title="case" class="img-fluid rounded z-depth-1" caption="Figure 2: The pitch shape of four main tones in Mandarin."%}
...
{% include figure.liquid path="assets/img/ReLyMe/pitch_shape_bad_case.jpg" title="case" class="img-fluid rounded z-depth-1" caption="Figure 3: A bad case that breaks pitch transition principle. The \"deng1 ta3\" of the lyrics means \"lighthouse\", but it sounds like \"deng3 ta1\" meaning \"waiting for him\"." %}
...
{% include figure.liquid path="assets/img/ReLyMe/strong_weak.jpg" title="case" class="img-fluid rounded z-depth-1" caption="Figure 4: A bad case that assigns an auxiliary word to downbeat. The question auxiliary “ma” is heard as “ma”, which means mother." %}
...
{% include figure.liquid path="assets/img/ReLyMe/obj_result.png" class="img-fluid rounded" caption="Table 1: Objective Evaluation" %}
{% include figure.liquid path="assets/img/ReLyMe/sub_result.png" class="img-fluid rounded" caption="Table 2: Subjective Evaluation" %}
...
{% include video.liquid id=page.demoId class="rounded" caption="The melody generated with ReLyMe (in TeleMelody) given the lyric of “Qing Hua Ci” by Jay Chou." %}
